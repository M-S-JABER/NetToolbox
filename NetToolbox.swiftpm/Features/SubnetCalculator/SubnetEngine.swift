...
enum SubnetEngineError: LocalizedError, Equatable {
    ...
    var errorDescription: String? {
        switch self {
        case .invalidIPv4Address: String(localized: "error.subnet.invalidIPv4")
        case .invalidIPv6Address: String(localized: "error.subnet.invalidIPv6")
        case .invalidPrefix: String(localized: "error.subnet.invalidPrefix")
        case .invalidSubnetMask: String(localized: "error.subnet.invalidMask")
        case .nonContiguousMask: String(localized: "error.subnet.nonContiguous")
        }
    }
}
